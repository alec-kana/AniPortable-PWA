module.exports = {
  ...
  theme: {
    extend: {
      ...
      // range; sm/md/lg/xl above it are all stock Tailwind values, and 2xl
      // hands the column count to auto-fill so wide desktops keep adding
      // columns instead of stretching eight cards across the screen.
      screens: {
        xs: '360px',
      },
      colors: {
